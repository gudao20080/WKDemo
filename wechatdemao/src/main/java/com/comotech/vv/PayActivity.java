...
public class PayActivity extends Activity {
    ...
    public static final String APP_ID = "wx4ee027d6e9fe2607";
    private static final String APP_SECRET = "dab229bfdd4deda496d89656709451fb"; // APP_ID 对应的密钥
    private static final String APP_KEY = "BT6H8056ZglPUFZX2U5DjoM8kYfakVqdrgtnkF9wCpGuTLvpbPTwgtNDXvK9Cj5Wz1ShlGSo8Yuea01Srt54Nw8VfZ6t7KpoHSDlrehwfHcdasFiNefsuN3ARZ3vYCiF"; // APP_ID 对应的支付密钥

    /** 商家向财付通申请的商家id */
    public static final String PARTNER_ID = "1227288901";
    private final String PARTNER_KEY = "43144deed0842a0627eeb72c35b371d";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView payBtn = (TextView) findViewById(R.id.tv_pay);
